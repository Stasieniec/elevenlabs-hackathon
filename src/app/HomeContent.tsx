...
import { ArrowRight, Users, Target, Crown, GraduationCap, Scroll, Star, Briefcase, Heart, Shield, Presentation, Sword, BarChart, Mail, ChevronDown, Award, LogIn } from 'lucide-react';
  ...
  return (
    <ClientOnly>
      <div className="min-h-screen">
        ...
        <main>
          <SignedIn>
            <main className="pt-24 pb-12 bg-neutral-light min-h-screen flex items-center">
              <div className="container mx-auto px-4 text-center">
                <h2 className="text-4xl font-bold text-neutral-dark mb-4">Welcome Back!</h2>
                <p className="text-xl text-neutral mb-8">Ready to continue your journey?</p>
                <Link href="/dashboard">
                  <button className="btn btn-primary text-lg px-8 py-3 inline-flex items-center gap-2">
                    <LogIn className="w-5 h-5" /> Go to Dashboard
                  </button>
                </Link>
              </div>
            </main>
